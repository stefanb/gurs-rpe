...
hscsv:
	...
	csvcut -c X,Y,EID_HISNA_STEVILKA,HS_STEVILKA,HS_DODATEK,EID_NASELJE,EID_ULICA,EID_POSTNI_OKOLIS,EID_CETRTNA_SKUPNOST,EID_DZ_VOLISCE,EID_KRAJEVNA_SKUPNOST,EID_LOKALNO_VOLISCE,EID_LOKALNA_VOLILNA_ENOTA,EID_SOLSKI_OKOLIS,EID_UPRAVNA_ENOTA,EID_VASKA_SKUPNOST,EID_VOLILNA_ENOTA_DZ,EID_VOLILNI_OKRAJ,EID_KOHEZIJSKA_REGIJA,KO_ID,ST_STAVBE,EID_STAVBA,DATUM_SYS "$(TMP)HS-full.csv" > "$(DATAFOLDER)HS.csv"
