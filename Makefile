...
hscsv:
	...
	csvcut -c X,Y,EID_HISNA_STEVILKA,HS_STEVILKA,HS_DODATEK,EID_NASELJE,EID_ULICA,EID_POSTNI_OKOLIS,EID_CETRTNA_SKUPNOST,EID_KRAJEVNA_SKUPNOST,EID_VASKA_SKUPNOST,EID_STAVBA,DATUM_SYS "$(TMP)HS-full.csv" > "$(DATAFOLDER)HS.csv"
